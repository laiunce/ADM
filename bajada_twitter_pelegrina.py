...
# Logging
logging.basicConfig(    filename='/var/log/daemon_escucha_twitter_pelegrina.log',
                        filemode='a',
...
#telnet  27017 
WORDS = ['@DanielPelegrina','pelegrina, Pelegrina, PELEGRINA']
...
class StreamListener(tweepy.StreamListener): 
    ...
    def on_data(self, data):
        ...
        try:
            ...
            go = es.create(index="twitter_pelegrina",
                      doc_type="twitter_pelegrina",
                      id=datajson['id'],
                      body=datajson
                     )
